...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorSocialLogin", path: "../../../../../node_modules/.pnpm/@capgo+capacitor-social-login@8.3.9_@capacitor+core@8.2.0/node_modules/@capgo/capacitor-social-login"),
